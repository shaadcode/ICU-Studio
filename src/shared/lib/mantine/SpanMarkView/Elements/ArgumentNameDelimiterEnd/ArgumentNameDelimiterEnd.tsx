...
import classes from './ArgumentNameDelimiterEnd.module.css';
...
const ArgumentNameDelimiterEndMark = ({ children, ...props }: Props) => {
...
export default ArgumentNameDelimiterEndMark;
